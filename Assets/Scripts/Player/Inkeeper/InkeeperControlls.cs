...
namespace Adventurer.Player
{
    public class InkeeperControlls : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            _controls.InKeeper.Movement.performed += input => adventurer.MoveVector = input.ReadValue<Vector2>();
            _controls.InKeeper.Movement.canceled += input => adventurer.MoveVector = Vector2.zero;
