...
namespace Tavern.Interactor 
{
    public class InkeeperInventory : MonoBehaviour
    {
        ...
        private const string TreyChildPosition = "TreyPosition";

        private void Start()
        {
            _treyPosition = TransformExtension.GetChildObject(this.gameObject, TreyChildPosition).transform;
        }
